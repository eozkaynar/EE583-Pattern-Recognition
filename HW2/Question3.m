...
% omega1_train = omega1(1:250,:);
% omega1_test  = omega1(251:500,:);
% 
% omega2_train = omega2(1:250,:);
% omega2_test  = omega2(251:500,:);
...
% mean of data %% BUARASI NASIL OLACAK DÜŞÜN TEST-TRAIN nasıl ayrılacak
% mu1_o = mean(omega1_train)';
% mu2_o = mean(omega2_train)';
...
varience_estimator1 = outer_product1/N1;
...
varience_estimator2 = outer_product2/N2;
...
% Decision boundary function
decision_boundary_2  = @(x1_2, x2_2) n_2 * inv(varience_estimator1) * ([x1_2; x2_2] - x0_2);
